...
//	private ImageView cadre;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (this.monde.getEnnemiList().size()==0) {
			Cannibale c1 = new Cannibale(1, 1, monde.getTerrain());
			ImageView e = new ImageView();
			e.setImage(new Image ("ESCAPE_Montreuil_C1/source/Joueur_gif/Megamanx running_droite.gif"));
			vue.getChildren().add(e);
			e.setFitWidth(32);
			e.setFitHeight(32);
			e.setTranslateX(1*32);
			e.setTranslateY(1*32);
		};
